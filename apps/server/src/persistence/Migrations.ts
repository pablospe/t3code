...
import Migration0048 from "./Migrations/048_ProjectionThreadsTaskDetails.ts";
import Migration0049 from "./Migrations/049_ProjectionThreadsActionablePlan.ts";
...
export const migrationEntries = [
  ...
  [48, "ProjectionThreadsTaskDetails", Migration0048],
  [49, "ProjectionThreadsActionablePlan", Migration0049],
] as const;
