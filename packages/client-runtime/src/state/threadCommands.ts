...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    sendAttachedMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:send-attached-message",
      execute: (input: SendAttachedMessageInput) => sendAttachedMessage(input),
      scheduler,
      concurrency,
    }),
